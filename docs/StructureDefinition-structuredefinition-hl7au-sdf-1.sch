...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:StructureDefinition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm': maximum cardinality of 'extension' is 1</sch:assert>
