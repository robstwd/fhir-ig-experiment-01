Feature: HL7 AU StructureDefinition Base profile: expected failures for invariant 'hl7au-sdf-base-01'
...
I want invariant 'hl7au-sdf-base-01' to fail when expected to
...
#     Given a test file named "test-cases/StructureDefinition/structuredefinition-hl7au-sdf-base-01-fail-01.xml" exists
