Feature: HL7 AU CodeSystem Base profile: expected failures for element meta.profile fixed value
...
Scenario: CodeSystem.meta.profile value is completely wrong
    Given a test file named "test-cases/CodeSystem/codesystem-meta-profile-fixed-fail-01.xml" exists
...
Scenario: CodeSystem.meta.profile value has the wrong case
    Given a test file named "test-cases/CodeSystem/codesystem-meta-profile-fixed-fail-02.xml" exists
...
Scenario: CodeSystem.meta.profile url has 'https' instead of 'http'
    Given a test file named "test-cases/CodeSystem/codesystem-meta-profile-fixed-fail-03.xml" exists
