...
Scenario: version is '1.0.0'
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-01-pass-01.xml" against profile "structuredefinition-hl7au-csd-1"
...
Scenario: version is '1.0.5'
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-01-pass-02.xml" against profile "structuredefinition-hl7au-csd-1"
    Then the command should "succeed" with output message "Success: 0 errors"
...
Scenario: version is '3.7.11'
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-01-pass-03.xml" against profile "structuredefinition-hl7au-csd-1"
    Then the command should "succeed" with output message "Success: 0 errors"
