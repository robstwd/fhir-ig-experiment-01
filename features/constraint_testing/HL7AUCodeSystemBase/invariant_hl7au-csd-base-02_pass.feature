...
Scenario: URL has correct base with terminal value variation #1
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-02-pass-01.xml" against profile "structuredefinition-hl7au-csd-1"
...
Scenario: URL has correct base with terminal value variation #2
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-02-pass-02.xml" against profile "structuredefinition-hl7au-csd-1"
    Then the command should "succeed" with output message "Success: 0 errors"
...
Scenario: URL has correct base with terminal value variation #3
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-02-pass-03.xml" against profile "structuredefinition-hl7au-csd-1"
    Then the command should "succeed" with output message "Success: 0 errors"
...
Scenario: URL has correct base with NO terminal value
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-hl7au-csd-base-02-pass-04.xml" against profile "structuredefinition-hl7au-csd-1"
    Then the command should "succeed" with output message "Success: 0 errors"