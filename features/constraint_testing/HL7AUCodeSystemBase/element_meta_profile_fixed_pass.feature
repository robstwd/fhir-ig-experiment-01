...
Scenario: CodeSystem.meta.profile value is "http://hl7.org/fhir/StructureDefinition/shareablecodesystem"
    ...
    When I run the validator command on the instance "test/CodeSystem/codesystem-meta-profile-fixed-pass-01.xml" against profile "structuredefinition-hl7au-csd-1"
