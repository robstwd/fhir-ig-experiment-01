Feature: HL7 AU ValueSet Base profile: expected passes for invariant 'hl7au-vsd-base-01'
...
I want invariant 'hl7au-vsd-base-01' to pass when expected to
...
Scenario: version is '1.0.0'
    Given a test file named "test-cases/ValueSet/valueset-hl7au-vsd-base-01-pass-01.xml" exists
    And its element "ValueSet.version" has value "1.0.0"
...
Scenario: version is '1.0.5'
    Given a test file named "test-cases/ValueSet/valueset-hl7au-vsd-base-01-pass-02.xml" exists
    And its element "ValueSet.version" has value "1.0.5"
    When I run the validator command on this testfile against profile "structuredefinition-hl7au-vsd-1"
    Then the command should "succeed" with output message "Success: 0 errors"

Scenario: version is '3.7.11'
    Given a test file named "test-cases/ValueSet/valueset-hl7au-vsd-base-01-pass-03.xml" exists
    And its element "ValueSet.version" has value "3.7.11"
    When I run the validator command on this testfile against profile "structuredefinition-hl7au-vsd-1"
    Then the command should "succeed" with output message "Success: 0 errors"
