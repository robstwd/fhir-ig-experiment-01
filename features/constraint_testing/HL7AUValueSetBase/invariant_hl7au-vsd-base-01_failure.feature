...
Scenario: version is '1'
    ...
    And the command should "fail" with output message "Rule hl7au-vsd-base-01: 'The version number is in semantic versioning format ('n.n.n'), with the major version number at least 1' Failed"
